...
class RootDependencyNodeInput(
     ...
     *
     * todo (AB) : Make sure Idea plugin and CLI either use different resolutionId for the same resolution context  or
     * todo (AB) : uses different incremental cache storages,
     * todo (AB) : because plugin and CLI have different codeVersions:
     * todo (AB) : cache entry generated by plugin code can't be used by CLI and vice versa
     */
