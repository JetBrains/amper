...
```
curl -L "https://packages.jetbrains.team/maven/p/amper/amper/org/jetbrains/amper/cli/0.3.0-dev-432/cli-0.3.0-dev-432-wrapper.sh?download=true" > amper.sh & chmod +x amper.sh
```

### Windows (powershell)

```
Invoke-WebRequest -Uri https://packages.jetbrains.team/maven/p/amper/amper/org/jetbrains/amper/cli/0.3.0-dev-432/cli-0.3.0-dev-432-wrapper.bat?download=true -OutFile amper.bat
```
