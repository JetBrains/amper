...
```
Invoke-WebRequest -Uri https://packages.jetbrains.team/maven/p/amper/amper/org/jetbrains/amper/cli/0.3.0-dev-460/cli-0.3.0-dev-460-wrapper.bat?download=true -OutFile amper.bat
```
