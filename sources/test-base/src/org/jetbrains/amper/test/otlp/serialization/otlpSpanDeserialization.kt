...
package org.jetbrains.amper.test.otlp.serialization
...
import org.jetbrains.amper.test.otlp.proto.AnyValue
import org.jetbrains.amper.test.otlp.proto.KeyValue
import org.jetbrains.amper.test.otlp.proto.ResourceSpans
import org.jetbrains.amper.test.otlp.proto.Span
import org.jetbrains.amper.test.otlp.proto.Status
import org.jetbrains.amper.test.otlp.proto.TracesData
...
private class DeserializedSpanData(
    ...
    private val resource: org.jetbrains.amper.test.otlp.proto.Resource,
) : SpanData {
