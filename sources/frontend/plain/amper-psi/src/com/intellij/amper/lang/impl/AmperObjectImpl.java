...
public class AmperObjectImpl extends AmperObjectMixin implements AmperObject {

  public AmperObjectImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public AmperConstructorReference getConstructorReference() {
    return findChildByClass(AmperConstructorReference.class);
  }
