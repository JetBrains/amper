...
public abstract class AmperObjectElementImpl extends ASTWrapperPsiElement implements AmperObjectElement {

  public AmperObjectElementImpl(@NotNull ASTNode node) {
    super(node);
  }
