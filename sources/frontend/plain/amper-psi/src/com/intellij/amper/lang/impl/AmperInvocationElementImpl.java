...
public class AmperInvocationElementImpl extends AmperObjectElementImpl implements AmperInvocationElement {

  public AmperInvocationElementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public AmperInvocationExpression getInvocationExpression() {
    return findNotNullChildByClass(AmperInvocationExpression.class);
  }
