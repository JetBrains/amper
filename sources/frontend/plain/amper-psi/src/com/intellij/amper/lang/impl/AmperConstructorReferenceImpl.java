...
public class AmperConstructorReferenceImpl extends ASTWrapperPsiElement implements AmperConstructorReference {

  public AmperConstructorReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public AmperValue getValue() {
    return findNotNullChildByClass(AmperValue.class);
  }
