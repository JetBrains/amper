...
private class BuiltInCatalog(
    ...
    override val entries: Map<String, TraceableString> = buildMap {
        ...
        if (springBootVersion != null) {
            ...
            put("vaadin.bom", library("com.vaadin:vaadin-bom", "24.8.7"))
            ...
            put("vaadin.feature.pack.flow", library("com.vaadin:vaadin-feature-pack-flow", "24.8.2"))
            put("vaadin.spring.bom", library("com.vaadin:vaadin-spring-bom", "24.8.7"))
            put("vaadin.swing.kit.client", library("com.vaadin:vaadin-swing-kit-client", "2.4.1"))
            put("vaadin.swing.kit.client.api", library("com.vaadin:vaadin-swing-kit-client-api", "2.4.1"))
            put("vaadin.swing.kit.flow", library("com.vaadin:vaadin-swing-kit-flow", "2.4.1"))
