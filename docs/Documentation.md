...
For the existing JVM and Kotlin Multiplatform [Gradle-based](#gradle-based-projects) projects, Amper also supports layout like: 
```
|-src/
|  |-main/
|  |  |-kotlin
...
plugins {
    // Add the plugin
    id("org.jetbrains.amper.settings.plugin").version("0.3.0-dev-447")
}
```
