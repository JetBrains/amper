...
Linux/macOS:
```
curl -fsSL -o amper "https://packages.jetbrains.team/maven/p/amper/amper/org/jetbrains/amper/cli/0.7.0-dev-2808/cli-0.7.0-dev-2808-wrapper?download=true" && chmod +x amper
```

Windows PowerShell:
```
Invoke-WebRequest -OutFile amper.bat -Uri https://packages.jetbrains.team/maven/p/amper/amper/org/jetbrains/amper/cli/0.7.0-dev-2808/cli-0.7.0-dev-2808-wrapper.bat?download=true
```
...
plugins {
    ...
    id("org.jetbrains.amper.settings.plugin").version("0.7.0-dev-2808")
}
// ...
```
