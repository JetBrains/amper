...
Linux/macOS:
```
curl -fsSL -o amper "https://maven.pkg.jetbrains.space/public/p/amper/amper/org/jetbrains/amper/cli/0.3.0-dev-577/cli-0.3.0-dev-577-wrapper.sh?download=true" && chmod +x amper
```

Windows powershell:
```
Invoke-WebRequest -Uri https://maven.pkg.jetbrains.space/public/p/amper/amper/org/jetbrains/amper/cli/0.3.0-dev-577/cli-0.3.0-dev-577-wrapper.bat?download=true -OutFile amper.bat
```
