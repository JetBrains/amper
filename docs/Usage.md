...
plugins {
    ...
    id("org.jetbrains.amper.settings.plugin").version("0.5.0-dev-2097")
}
// ...
```
...
Linux/macOS:
```
curl -fsSL -o amper "https://packages.jetbrains.team/maven/p/amper/amper/org/jetbrains/amper/cli/0.5.0-dev-2097/cli-0.5.0-dev-2097-wrapper?download=true" && chmod +x amper
```

Windows powershell:
```
Invoke-WebRequest -Uri https://packages.jetbrains.team/maven/p/amper/amper/org/jetbrains/amper/cli/0.5.0-dev-2097/cli-0.5.0-dev-2097-wrapper.bat?download=true -OutFile amper.bat
```
