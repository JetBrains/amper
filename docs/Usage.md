...
Linux/macOS:
```
curl -fsSL -o amper "https://packages.jetbrains.team/maven/p/amper/amper/org/jetbrains/amper/amper-cli/0.7.0-dev-2818/amper-cli-0.7.0-dev-2818-wrapper?download=true" && chmod +x amper
```

Windows PowerShell:
```
Invoke-WebRequest -OutFile amper.bat -Uri https://packages.jetbrains.team/maven/p/amper/amper/org/jetbrains/amper/amper-cli/0.7.0-dev-2818/amper-cli-0.7.0-dev-2818-wrapper.bat?download=true
```
...
plugins {
    ...
    id("org.jetbrains.amper.settings.plugin").version("0.7.0-dev-2818")
}
// ...
```
