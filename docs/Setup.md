...
* Use [Android Studio 2023.3 Preview](https://developer.android.com/studio/preview/) version 2023.3.1 Canary 1 or higher for JVM and Android projects.
...
If you use IntelliJ IDEA or Android Studio, install the Amper plugin: ![](images/ij-plugin.png)
...
- Try opening [an example project](../examples/jvm-hello-world) in IntelliJ IDEA, Android Studio or in Fleet. 
  You should get completion in the module.yaml files:
  ![](images/amper-in-ij.png)
  ![](images/amper-in-fleet.png)

### What's next
See the [tutorial](Tutorial.md) and [documentation](Documentation.md). Read how to use Amper in [IntelliJ IDEA](Usage.md#using-amper-in-intellij-idea-and-android-studio), [Android Studio](Usage.md#using-amper-in-intellij-idea-and-android-studio) and [Fleet](Usage.md#using-amper-in-fleet). Try opening the examples projects:
