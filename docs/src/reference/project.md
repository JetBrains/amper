...
The `modules` section defines which modules are part of this Kargo project.
...
!!! info
    Currently, only dependencies on **local** plugin modules are supported here (Kargo doesn't support publishing 
    plugins yet, ).
