---
description: A brief introduction to the YAML language used in Kargo configuration files.
---
# Brief YAML primer

Kargo uses (a subset of) the YAML language for configuration files.
