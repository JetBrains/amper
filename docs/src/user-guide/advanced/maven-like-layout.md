---
description: |
  Kargo is opinionated about where to put your sources, resources, and tests.
...
Kargo is opinionated about where to put your sources, resources, and tests (see the 
...
the build configuration files. To smoothen the transition, Kargo provides an alternative layout that is compatible with
...
!!! note
    ...
    There is no difference between `java/` and `kotlin/` folders, Kargo will look for java and kotlin sources in both
