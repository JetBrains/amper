...
val bootstrapAmperVersion = "0.6.0-dev-2549" // AUTO-UPDATED BY THE CI - DO NOT RENAME
...
val kspVersion = "2.1.20-RC2-1.0.31" // KSP2 still has some Kotlin version in it, but it doesn't have to be in sync
