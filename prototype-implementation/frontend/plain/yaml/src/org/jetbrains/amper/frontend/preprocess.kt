...
fun Yaml.parseAndPreprocess(
    ...
    val rootConfig = loadFile(absoluteOriginPath, contentReader).getOrElse { return amperFailure() }
    ...
    if (hasBrokenTemplates) return amperFailure()
...
private fun mergeTemplate(
    ...
    if (hasProblems) return amperFailure()
