...
import com.intellij.deft.codeInsight.DeftPotReferenceManager.PotFilter
...
internal class DeftPotReference(element: PsiElement, private val template: Boolean) :
  ...
  override fun getVariants(): Array<Any> {
    ...
    referenceManager.processPotFiles(GlobalSearchScope.projectScope(project), potFilter) { file ->
      ...
      val potRelativePath = (VfsUtilCore.getRelativeLocation(filePath, projectDir) ?: filePath.presentableUrl).takeIf { it.isNotBlank() }
                            ?: "<root Pot>"
