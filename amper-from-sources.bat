...
"%AMPER_JAVA_HOME%\bin\java.exe" "-Damper.wrapper.path=%~f0" %jvm_args% -cp "%~dp0build\tasks\_cli_unpackedDist\dist\lib\*" org.jetbrains.amper.cli.MainKt --build-output="build-from-sources" %*
exit /B %ERRORLEVEL%
